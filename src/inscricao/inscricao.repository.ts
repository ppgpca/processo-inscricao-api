...
export class InscricaoRepository {
  ...
  async obterPorCpfEdital(cpf: string, idEdital: number): Promise<Inscricao | null> {
  ...
  async obterDuplicata(cpf: string, idEdital: number): Promise<Inscricao | null> {
  ...
  async atualizar(inscricao: Inscricao, dados: UpdateInscricaoDto): Promise<Inscricao> {
