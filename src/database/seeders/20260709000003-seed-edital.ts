    ...
    await dataSource.getRepository(Edital).insert([
      {
        ...
        descricao: 'Processo seletivo para aluno regular do curso de Mestrado Profissional em Computação Aplicada, campus Chapecó/UFFS, com ingresso em 2027.1, conforme Portaria nº 4344/GR/UFFS/2025 e Resolução 71/CONSUNI CPPGEC/UFFS/2025',
        ano: 2026,
        ...
        vagasTotal: 15,
        status: 'rascunho',
        urlEditalPdf: 'https://www.uffs.edu.br/uffs/profissional-em-computacao-aplicada/apresentacao',
        ativo: true,
      },
    ]);
  }
