...
export class Edital {
  ...
  @Column({ name: 'data_inicio_inscricao', type: 'timestamptz', nullable: false })
  dataInicioInscricao: Date;

  @Column({ name: 'data_fim_inscricao', type: 'timestamptz', nullable: false })
  dataFimInscricao: Date;

  @Column({ name: 'data_inicio_avaliacao', type: 'timestamptz', nullable: true })
  dataInicioAvaliacao: Date | null;

  @Column({ name: 'data_fim_avaliacao', type: 'timestamptz', nullable: true })
  dataFimAvaliacao: Date | null;

  @Column({ name: 'data_divulgacao_resultado', type: 'timestamptz', nullable: true })
  dataDivulgacaoResultado: Date | null;

  @Column({ name: 'data_inicio_preferencia_orientador', type: 'timestamptz', nullable: true })
  dataInicioPreferenciaOrientador: Date | null;

  @Column({ name: 'data_fim_preferencia_orientador', type: 'timestamptz', nullable: true })
