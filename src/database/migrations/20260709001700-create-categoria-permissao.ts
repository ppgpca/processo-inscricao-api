...
export class CreateCategoriaPermissao20260709001700 implements MigrationInterface {
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS public.categoria_permissao`);
  }
}
