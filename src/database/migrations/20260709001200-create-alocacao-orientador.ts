...
export class CreateAlocacaoOrientador20260709001200 implements MigrationInterface {
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS public.alocacao_orientador`);
  }
}
